 ...
 * u otros microservicios (por ejemplo mspedidos, que
 * consumirá este microservicio para aplicar descuentos).
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> promocionNoEncontrada(
            PromocionNotFoundException ex) {
